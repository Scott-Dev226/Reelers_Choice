          ...
          <li id="Nav-Item">
            <div id="search_holder">
              <input
                ...
                type="text"
                id="search"
                placeholder="Search for any Movie... (+ Enter)"
    ...
    <div id="main-container" class="dynamic_HQ">
      <div class="movie_Info_Div" id="movie_Info_Div">
        ...
        <img
          id="carousel-btn2"
          src="red_arrow.png"
          onclick="carousel_push('pull')"
        />
        <img
          src="green_arrow.png"
          id="carousel-btn"
          type="button"
          onclick="carousel_push('push')"
        />
...
<img id = "plot-preview-img"  src = "ticket.jpg">  </img>
        ...
        <div id="user_reactions">
          ...
          <div id="user5_reaction" class="user_reaction_ind">
            ...
            <li id="reaction_line">
              <span style="color: grey"> DATE: </span> <span id="date5"> </span>
            </li>
            <li id="reaction_line">
