...
<head>
  ...
  window.onload = function(){
    	 gsap.to(".signup_body", { duration: 5, opacity: 1 });
...
<form action="sign_up_logic.php" method="post" class = "my_registerform">
    <input class = "sign_field" type="text" name="name" placeholder="First Name...">
    <input class = "sign_field" type="text" name="email" placeholder="Enter a Valid Email...">
    <input class = "sign_field" type="text" name="uid" placeholder="Enter Username...">
    <input class = "sign_field" type="password" name="pwd" placeholder="Enter Password...">
    <input  class = "sign_field" type="password" name="pwdrepeat" placeholder="Re-enter Password...">
...
?>
 ...
 <a href= "login.php" class = "api_info"> Already signed up? Click here to Login!"</a>


 <img id = "api_logo" src = "tmdb.svg" >
<p class = "api_info">This product uses the TMDb API but is not endorsed or certified by TMDb</p>
